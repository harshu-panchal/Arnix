...
export default function SellerOrderDetail() {
  ...
  const handleExportPDF = () => {
    ...
    doc.text('ARNIX - Rewards beyond limit', margin + 5, yPos + 10);
    ...
    doc.setFontSize(12);
    doc.setFont('helvetica', 'bold');
    doc.text('ARNIX - Rewards beyond limit', margin, yPos);
    yPos += 7;

    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    doc.text('From: ARNIX - Rewards beyond limit', margin, yPos);
    yPos += 6;
    ...
    doc.text('Bill Generated by ARNIX - Rewards beyond limit', pageWidth / 2, yPos, { align: 'center' });
    yPos += 8;

    doc.setFontSize(8);
    doc.text('Copyright © 2025. Developed By ARNIX - Rewards beyond limit', pageWidth / 2, yPos, { align: 'center' });
    ...
    <div className="min-h-screen bg-neutral-50 pb-8">
        ...
        <div className="bg-white px-4 sm:px-6 py-6">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-6 mb-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <div>
                  <div className="text-xs text-green-600 font-semibold">ARNIX</div>
                  <div className="text-[10px] text-green-600">in 10 Minutes</div>
                </div>
              </div>
              <h1 className="text-2xl sm:text-3xl font-bold text-neutral-900 mb-2">ARNIX - Rewards beyond limit</h1>
              <div className="text-sm text-neutral-600 mb-1">
                <span className="font-medium">From:</span> ARNIX - Rewards beyond limit
              </div>
          ...
          <div className="border-t border-dashed border-neutral-300 pt-4">
            <p className="text-sm text-neutral-600 text-center">
              Bill Generated by ARNIX - Rewards beyond limit
            </p>
          </div>
        </div>
      </div>
      ...
      <footer className="mt-6 px-4 sm:px-6 text-center py-4 bg-neutral-100 rounded-lg">
        <p className="text-xs sm:text-sm text-neutral-600">
          ...
          <span className="font-semibold text-teal-600">ARNIX - Rewards beyond limit</span>
        </p>
      </footer>
    </div>
  );
